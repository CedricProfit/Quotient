...
static const int LAST_POW_BLOCK = 6843;
...
static const int64_t MAX_MONEY = 1618033 * 2 * COIN; // include overhead for stake interest
static const int64_t COIN_YEAR_REWARD = 1618 * CENT; // 1,618% per year
...
static const uint256 hashGenesisBlock("0x000035ed4831dc8024bd05ca9c7d94647f2ec655022cfe16d25811cbd2ed4a81");
static const uint256 hashGenesisBlockTestNet("0x000035ed4831dc8024bd05ca9c7d94647f2ec655022cfe16d25811cbd2ed4a81");


inline int64_t PastDrift(int64_t nTime)   { return nTime - 6 * 60; } // up to 6 minutes from the past
inline int64_t FutureDrift(int64_t nTime) { return nTime + 6 * 60; } // up to 6 minutes from the future
